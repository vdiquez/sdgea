# SGDEA — Constitución del Proyecto
...
Solo este archivo (`.specify/memory/constitution.md`) es de solo lectura para
agentes y solo se comitea con `HUMAN=1` — es el único archivo sellado del proyecto.

**Version**: 1.0.0 | **Ratified**: 2026-05-22 | **Last Amended**: 2026-08-19
<!-- Ratified: fecha de modificación del archivo original (00-constitution.md),
     única evidencia disponible — no hay commit anterior a rastrear. Confírmala o
     corrígela si la recuerdas distinta. Last Amended: fecha de esta migración de
     ruta; el contenido de los principios no cambió. -->
