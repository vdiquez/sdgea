...
class EventoAuditoria:
    ...
    # otro contexto ("VALIDACION_APLICADA" en normalizacion) sin ninguna
    # columna que identifique el origen -- SEGUNDO VETO real de Codex sobre
    # T-58: excluir esas filas era tan deshonesto como atribuírselas a un
    # solo contexto sin certeza. Se muestran en AMBOS, marcadas como tales,
    # nunca como un evento propio confirmado.
